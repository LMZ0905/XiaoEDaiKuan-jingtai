            ...
            if (sub_ul.length != 0) { //1表
                ...
                a_el[0].onclick = function () {
                    ...
                    switch (num) {
                        case 27:{
                            //先进行初始化
                            var get=document.getElementsByClassName('one-lmz');
...
function createLeftNavs(id) {
    ...
    if (data1.length != 0) {
        for (var i = 0; i < data1.length; i++) {
            ...
            a.innerText = data1[i];
            a.style.background = '#f5f3f3 url(./sources/images/shouye/n'+(i+1)+'.png) no-repeat left center';
        ...
        s_li = document.createElement('li');
                ...
                s_a.style.background='#f5f3f3 url(./sources/images/shouye/1111/n'+i+j+'.png) no-repeat left center';
